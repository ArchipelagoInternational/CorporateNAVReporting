<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VAT.aspx.cs" Inherits="CorporateNAVReporting.Reports.VAT" %>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <asp:UpdatePanel ID="upReport" runat="server" UpdateMode="Always" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            Account No. : <asp:TextBox ID="txtAccountNo" Text="21302001" runat="server"
                                Enabled="false" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>&nbsp;
